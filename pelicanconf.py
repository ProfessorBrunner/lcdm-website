...
JINJA_FILTERS = { 'recentNews': recentNews }
...
DIRECT_TEMPLATES = (('index', 'lcdmposts', 'lcdmnews'))
PAGINATED_DIRECT_TEMPLATES = (('lcdmposts', 'lcdmnews'))
LCDMPOSTS_SAVE_AS = ('blog/index.html')
LCDMNEWS_SAVE_AS = ('news/index.html')
...
THEME = 'pelican-themes/lcdm'

PLUGIN_PATH = 'pelican-plugins'
PLUGINS = ['latex', 'summary', 'assets']
